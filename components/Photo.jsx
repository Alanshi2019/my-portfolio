  ...
  return <div className='w-full h-full relative'>
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 2, duration: 0.4, ease: "easeIn" } }}>
      <motion.div
        ...
        <Image src="https://drive.google.com/file/d/1sgH_dNzo0uvHx5dv1qyiUehn18pekeky/view?usp=drive_link" priority quality={100} fill alt="profile-image" className='object-container rounded-full' />
      </motion.div>
